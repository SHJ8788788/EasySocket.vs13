...
namespace EasySocket.vs13
{
    ...
    internal class PlugManager
    {
        ...
        /// <returns></returns>
        public bool RaiseConnected(object sender, IContext context)
        {
        ...
        /// <param name="context">上下文</param>
        /// <returns></returns>
        public bool RaiseRequested(object sender, IContext context)
        {
            foreach (var item in this.plugs)
            {
        ...
        /// <param name="context">上下文</param>
        /// <returns></returns>
        public bool RaiseSended(object sender, IContext context)
        {
            foreach (var item in this.plugs)
            {
                if (context.Session.IsConnected == false)
        ...
        /// <param name="sender">发生者</param>
        /// <param name="context">上下文</param>
        public void RaiseDisconnected(object sender, IContext context)
        {
            foreach (var item in this.plugs)
            {
