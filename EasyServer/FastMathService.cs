...
namespace EasyServer
{
    ...
    /// Easy协议Api服务  
    /// </summary>
    public class EasyMathService : EasyApiService
    {
        /// <summary>
        /// 获取其它已登录的会话
        /// </summary>
        ...
        public LoginResult Login(UserInfo user, bool ifAdmin)
        {
            ...
            return new LoginResult { State = true ,Message = user.Account+"登陆成功！！"};
        }
        ...
        public LoginResult Logoff(UserInfo user, bool ifAdmin)
        {
            ...
            return new LoginResult { State = false, Message = user.Account + "已注销！！" };
        }
